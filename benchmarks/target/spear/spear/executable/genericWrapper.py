...
class AbstractWrapper(object):
    ...
    def main(self, argv=None): 
        ...
        try:
            ...
            self.parser.add_argument("--runsolver-path", dest="runsolver", default="./target_algorithms/runsolver/runsolver", help="path to runsolver binary (if None, the runsolver is deactivated)")
