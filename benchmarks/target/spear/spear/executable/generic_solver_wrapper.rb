...
require File.expand_path("~/algorithms/spear/aclib/executable/callstring_generator.rb")
$true_solubility_file = File.expand_path("~/instances/sat/true_solubility.txt") 
$orig_input_file = input_file
runsolver_executable = File.expand_path("~/algorithms/runsolver/runsolver")
SAT_executable = File.expand_path("~/algorithms/spear/aclib/executable/SAT")
